  ...
  <div class="payment-shell">
    ...
    <div class="payment-card">
      ...
      <div class="payment-qr">
        ...
        <p class="payment-auto-check">{{ $paymentUi['status_help'] }}</p><a class="payment-support" href="tel:19002879">{{ $paymentUi['support'] }} · 1900 2879</a>
        @else
