...
<section class="py-16 bg-[#f8fdf9]">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:1900 2879" class="bg-brand-green text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#096b39] transition-colors inline-flex items-center justify-center gap-2">
