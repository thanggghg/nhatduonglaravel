...
<div class="posts-studio">
    <section class="posts-studio__hero">
        ...
        <div class="posts-studio__hero-actions">
            <nav class="posts-studio__locale-filter" aria-label="Lọc bài viết theo ngôn ngữ">
                <a href="{{ route('admin.posts.index') }}" @class(['is-active' => !$locale])>Tất cả</a>
                <a href="{{ route('admin.posts.index', ['locale' => 'vi']) }}" @class(['is-active' => $locale === 'vi'])>VI</a>
                <a href="{{ route('admin.posts.index', ['locale' => 'en']) }}" @class(['is-active' => $locale === 'en'])>EN</a>
                <a href="{{ route('admin.posts.index', ['locale' => 'ru']) }}" @class(['is-active' => $locale === 'ru'])>RU</a>
            </nav>
                            ...
                            <td data-label="Bài viết">
                                <div class="posts-studio__story">
                                    ...
                                    <div>
                                        ...
                                        <span class="posts-studio__locale">{{ strtoupper($post->locale) }}</span>
...
@push('styles')
<style>.posts-studio__locale-filter{display:flex;overflow:hidden;border:1px solid rgba(212,244,226,.45);border-radius:8px}.posts-studio__locale-filter a{padding:7px 9px;color:#d4f4e2;border-right:1px solid rgba(212,244,226,.28);font-size:10px;font-weight:800;text-decoration:none}.posts-studio__locale-filter a:last-child{border-right:0}.posts-studio__locale-filter a:hover,.posts-studio__locale-filter .is-active{color:#563d00;background:#fbb116}.posts-studio__locale{display:inline-flex;margin-top:5px;padding:2px 5px;color:#0b7f42;background:#e8f8ef;border-radius:4px;font-size:9px;font-weight:900;letter-spacing:.06em}.posts-studio__story p{margin-top:4px}</style>
@endpush
